...
import (
	...
	loggerConfig "github.com/MAAF1/Go-Boilerplate/internal/logger"
...
// implements pgx tracer interface
...
func New(cfg *config.Config, logger *zerolog.Logger, loggerService *loggerConfig.LoggerService) (*Database, error) {
	...
	if cfg.Primary.Env == "local" {
		...
		// chain tracing newrelic first then local logging
